public class L6 {
    public static void main(String[] args) {
        ...
        // no 3.14 it inacc, use
        System.out.println(Math.PI);

        //Math.max(double a, double b) returns highest of 2 values as data types
        //Math.min(double a, double b) returns lowest of 2 values as data types
        int num1 = 2;
        int num2 = 14;
        int num3 = 10;
